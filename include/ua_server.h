 ...
 * Using this method deletes the node generated by ``UA_Server_createEvent``.
 */
#ifdef UA_ENABLE_EVENTS

UA_StatusCode UA_Server_createEvent(UA_Server *server, UA_NodeId eventType,
                                    UA_NodeId *outNodeId);

UA_StatusCode UA_Server_triggerEvent(UA_Server *server, UA_NodeId *event,
                                     UA_NodeId *origin, UA_ByteString *outId);
